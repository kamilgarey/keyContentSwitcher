...
keyContentSwitcher = new (function () {
    ...
    this.init = function () {
        ...
        jQuery(self.getItemsSelector(self.ItemType.link)).live("click", function (e) {
    ...
    function activateGroups(jqSelector, ignoredGroupKeys) {
        ...
        for (var groupKey in groups) {
            ...
            if (!(ignoredGroupKeys.indexOf(groupKey) > -1 || !group.htmlElements || group.htmlElements.length <= 0 || group.hasActive)) {
